...
nFrame = 1; % number of frame
tot_i = 1; % index of the overall matrix

% detect moving objects, and track them across video frames
while ~isDone(obj.reader) && frames2use >= nFrame
    frame = readFrame();
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader('40x_1st.mp4');
...
% initialize  a new field: {centroid}
...
% remove noisy pixels and to fill the holes in the remaining blobs.
    ...
    function [centroids, bboxes, mask] = detectObjects(frame)
        ...
        % todo - change this. morphological
...
% assigned tracks and detections in its two columns. 
% 
% It also returns the
    ...
    function createNewTracks()
        ...
        for i = 1:size(centroids, 1)
            ...
            kalmanFilter = configureKalmanFilter('ConstantAcceleration', ...
                centroid, [200, 50, 50], [100, 25, 25], 100);
